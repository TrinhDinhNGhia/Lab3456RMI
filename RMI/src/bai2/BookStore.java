 ...
 * @author Nghia
 */
public abstract  class BookStore extends UnicastRemoteObject implements RMIInterface{
...
public static void main(String[] args) {
 try {
     ...
     @Override
           public ArrayList<java.awt.print.Book> allBooks() throws RemoteException {
    ...
    @Override
    public java.awt.print.Book findBook(java.awt.print.Book b) throws RemoteException {
